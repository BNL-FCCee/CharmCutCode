...
class MetadataContainer
{
   public:
      ...
      std::string getDetectorVarFile(){return m_DetectorVarFile;};
      std::string getDetectorVar(){return m_DetectorVar;};
   ...
   protected:
      ...
      std::string m_DetectorVarFile;
      std::string m_DetectorVar;
      int m_nEvents;
};
